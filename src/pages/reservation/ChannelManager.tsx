  ...
  const columns = [
    {
      title: () => (
        <>
          ...
          <span style={{ paddingLeft: 15 }}>Supervisor Double</span>
          <svg
            fill="none"
            height="14"
            style={{ float: 'right' }}
        ...
        if (index === 0) {
          return (
            <>
              ...
              <span style={{ color: '#1D39C4', fontSize: 12, paddingLeft: 10, paddingRight: 5 }}>
                1 Channel
              </span>
              <svg
                fill="none"
    ...
    },
    {
      ...
      render: (value: any, record: object, index: number) => {
        ...
        return (
          <span style={{ color: 'rgba(0, 0, 0, 0.65)', fontSize: 12, fontWeight: 700 }}>RATES</span>
        );
      },
    },
    {
